 ...
 */
public class FilterExpressionParserNew {
    ...
    public FilterExpressionParserNew() {
        this.operatorRegistry = OperatorRegistry.withDefaultOperators();
    }

    public FilterExpressionParserNew(OperatorRegistry operatorRegistry) {
    ...
    private Expression handleBinary(Map.Entry entry, String key) {
        ...
        if (entry.getValue() instanceof Collection) {
            final List<Comparable> operandValues = (List<Comparable>) entry.getValue();
        ...
        final ExpressionValue<Comparable> expressionValue = new ExpressionValue(expressionValues);
